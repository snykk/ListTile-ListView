...
import './mendut_detail.dart';
import './prambanan_detail.dart';
import 'borobudur_detail.dart';
import 'dieng_detail.dart';
import 'gedong_songo_detail.dart';
import 'kalasan_detail.dart';
import 'muara_takus_detail.dart';

class MyPotraitPage extends StatelessWidget {
  const MyPotraitPage({
    Key? key,
  }) : super(key: key);
      ...
      children: [
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) {
              return const Gedong_Songo_Detail();
            }));
          },
        ),
        ListTile(
          ...
          onTap: () {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) {
              return const Muara_Takus_Detail();
            }));
          },
        ),
        ListTile(
